...
/* PDP images: use /images/… from the repo so they load on aem.page without DA media blobs. */
  ...
  <main>
    ...
    <div>
      <div class="product-detail">
        <div>
          <div>
            <picture><img src="/images/pdp-g4-97-main.jpg" alt="LG OLED evo G4 97 pouces — vue principale"></picture>
            <picture><img src="/images/pdp-g4-97-main.jpg" alt="LG OLED evo G4 97 pouces — vue principale"></picture>
            <picture><img src="/images/pdp-g4-97-side.jpg" alt="Vue de profil"></picture>
            <picture><img src="/images/pdp-g4-97-wall.jpg" alt="Fixation murale"></picture>
            <picture><img src="/images/pdp-g4-97-lifestyle.jpg" alt="Ambiance salon"></picture>
            <picture><img src="/images/pdp-g4-97-rear.jpg" alt="Connectique arrière"></picture>
            <picture><img src="/images/pdp-g4-97-mount.jpg" alt="Support mural motorisé"></picture>
          </div>
          <div>
            <p><strong>G4 SERIES | GALLERY EDITION</strong></p>
            <h1>LG OLED evo G4 97'' 4K Smart TV</h1>
            <p><em>OLED97G45LW.BEU</em></p>
            <p>Processeur AI alpha-11 · Performances IA jusqu'à 300 % plus rapides pour une netteté absolue</p>
            <p>24 999,00 €</p>
            <p>Prix conseillé</p>
    ...
    <div>
      <div class="columns">
        <div>
          <div>
            <picture><img src="/images/pdp-g4-97-lifestyle.jpg" alt="Ambiance LG OLED G4"></picture>
          </div>
          <div>
    ...
    <div>
      <div class="pdp-story pdp-story-wall">
        <div>
          <div>
            <h2>One Wall Design</h2>
            <p>Un chef-d'œuvre qui ne fait qu'un avec votre mur. Le support dédié permet à l'écran 97" de rester quasiment affleurant pour un effet galerie immersif.</p>
            <picture><img src="/images/pdp-g4-97-wall.jpg" alt="LG OLED G4 fixé au mur — One Wall Design"></picture>
          </div>
        </div>
      </div>
    </div>
    <div>
      <div class="pdp-story pdp-story-gaming">
        <div>
          <div>
            <p><strong>Jeu légendaire</strong></p>
            <h2>Vitesse 144 Hz inégalée</h2>
            <p><strong>Première OLED 97" 4K 144 Hz.</strong> Réponse 0,1 ms, compatibilité G-Sync, FreeSync Premium et HGIG pour le HDR gaming.</p>
            <p>Quatre ports <strong>HDMI 2.1</strong> (eARC, VRR) pour consoles et PC nouvelle génération.</p>
            <ul>
              <li><span>0,1 ms</span><span>Temps de réponse</span></li>
              <li><span>144 Hz</span><span>Fréquence</span></li>
              <li><span>4×</span><span>HDMI 2.1</span></li>
            </ul>
          </div>
          <div>
            <picture><img src="/images/pdp-g4-97-rear.jpg" alt="Jeu sur LG OLED G4"></picture>
          </div>
        </div>
      </div>
    </div>
    <div>
      ...
      <div class="product-specs">
        ...
        <div><div><p>Audio</p></div><div><p>Compatible LG Soundbar S95TR</p></div></div>
    ...
    <div>
      <div class="pdp-bundles">
        <div>
          <div>
            <h2>Complétez votre expérience</h2>
          </div>
        </div>
        <div>
          <div>
            <picture><img src="/images/promo-audio.jpg" alt="LG Soundbar S95TR"></picture>
            <h3>LG Soundbar S95TR</h3>
            <p>Audio haute fidélité sans fil pour votre salon cinéma.</p>
            <p><strong>1 499,00 €</strong></p>
            <p><em><a href="#">Ajouter au pack</a></em></p>
          </div>
          <div>
            <picture><img src="/images/pdp-g4-97-mount.jpg" alt="Support mural motorisé"></picture>
            <h3>Support mural motorisé</h3>
            <p>Montage motorisé pour un angle de vision idéal.</p>
            <p><strong>899,00 €</strong></p>
            <p><em><a href="#">Ajouter au pack</a></em></p>
          </div>
          <div>
            <picture><img src="/images/features-smart-home.jpg" alt="LG Premium Care+"></picture>
            <h3>LG Premium Care+</h3>
            <p>Extension de garantie et services premium.</p>
